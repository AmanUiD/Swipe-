...
public class StarFragment extends Fragment implements com.example.swipe.ItemTouchHelper {
    ...
    private List<User> getUserList() {
        ...
        list.add(new User("Flipkart", "Your cart miss you", "Hurry up, ther are other looking for big deal..", "1:23am", R.drawable.linkedin,   R.drawable.ic_star));
        list.add(new User("Flipkart", "Your cart miss you", "Hurry up, ther are other looking for big deal..", "1:23am", R.drawable.lenskart,  R.drawable.ic_star));
        list.add(new User("Flipkart", "Your cart miss you", "Hurry up, ther are other looking for big deal..", "1:23am", R.drawable.flipkart,  R.drawable.ic_star));
        list.add(new User("Flipkart", "Your cart miss you", "Hurry up, ther are other looking for big deal..", "1:23am", R.drawable.linkedin,   R.drawable.ic_star));
        list.add(new User("Flipkart", "Your cart miss you", "Hurry up, ther are other looking for big deal..", "1:23am", R.drawable.lenskart,   R.drawable.ic_star));
        list.add(new User("Flipkart", "Your cart miss you", "Hurry up, ther are other looking for big deal..", "1:23am", R.drawable.flipkart,   R.drawable.ic_star));
